...
void lead_synth_preset(struct sfx_box *box) {
    ...
    sfx_box_change(box, ZV_WIDTH, 0, 0.75);
...
int main(int argc, char **argv) {
    ...
    sfx_box_change(box4, ZV_VOLUME, 0, 0.05);
    song(0.8);
    for (int i = 0; i < CHANNELS; i++) {
